...
TAKE_PROFITS = [0.30]   # هدف واحد فقط: +30% — ثم وقف الخسارة ينتقل لسعر الدخول
# استراتيجية "الجني الجزئي + التعادل": عند الهدف يُباع 50%، والنصف المتبقي
# يصبح خالي المخاطر (وقف الخسارة = سعر الدخول)
...
# توزيع البيع الجزئي: عند الهدف الوحيد يُباع 50%، والنصف المتبقي يكمل
# بوقف خسارة عند سعر الدخول (خالي المخاطر)
PAPER_SELL_FRACTIONS = (0.5,)
